 ...
 */
public class Flink12_Window_CountSliding {
    private static final Logger LOG = LoggerFactory.getLogger(Flink12_Window_CountSliding.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 5.开窗，countWindow
        WindowedStream<Tuple2<String, Integer>, String, GlobalWindow> windowedStream = keyedStream.countWindow(6, 2);
