 ...
 */
public class Flink05_Window_EventTimeTumbling_CustomerPeriodic {
    private static final Logger LOG = LoggerFactory.getLogger(Flink05_Window_EventTimeTumbling_CustomerPeriodic.class);
     ...
     * 自定义周期性的watermark生成器
     */
    public static class MyPeriod implements WatermarkGenerator<WaterSensor_Java> {
        private Long maxTs;
        /**
         * 指定延迟
         */
