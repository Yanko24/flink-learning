...
/**
 * @Description GroupWindow-SessionWindow
 * @Date 2022/3/16 20:28
 * @Author yankee
 */
public class FlinkSQL09_TableAPI_GroupWindow_CountTumblingWindow_ProcessTime {
    public static void main(String[] args) throws Exception {
        ...
        // group window
        Table result = table.window(Tumble.over(rowInterval(2L))
                        .on($("pt"))
                        .as("cw"))
                .groupBy($("id"), $("cw"))
                .select($("id"), $("vc").count());
