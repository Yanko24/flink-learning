 ...
 * @Author yankee
 */
public class FlinkSQL20_SQL_OverWindow {
    public static void main(String[] args) throws Exception {
        ...
        // overwindow
        Table result = tableEnv.sqlQuery("select word, " +
                "sum(cnt) over w as sum_cnt" +
                " from " + table +
                " window w as (partition by word order by pt rows between 2 preceding and current row)");
